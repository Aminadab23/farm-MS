          ...
          child: Column(children: [
               Container(
                margin: const EdgeInsets.symmetric(horizontal: 20, vertical: 10),
                 child: Row(
                    children: [
                      SizedBox(width:240, child:  Text(note.title, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 28),)),
                      // SizedBox(width: ,)
                      GestureDetector(
                        onTap: (){
                 ...
                 Container(
                  ...
                  padding: const EdgeInsets.only(left:12),alignment: Alignment.centerLeft,
