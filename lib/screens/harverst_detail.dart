    ...
    return Scaffold(
        ...
        body: Container(
            ...
            child: Column(children: [
              ...
              Row(children: [
                const Icon(Mdi.calendarAlert),
                Text(farm.date_to_harvest)
              ]),
              Row(children: [const Icon(Mdi.chartBar), Text(farm.quantity)]),
              Row(children: [const Icon(Mdi.information), Text(farm.quality)]),
